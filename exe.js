const data = [
  ...
  // Arceus X NEO
  {id:1,name:'Arceus X NEO',rating:4.5,avatar:'https://files.catbox.moe/6l8y21.webp',version:'2.716.875',versionVng:'2.715.1115',status:'online',statusVng:'online',platforms:['android'],downloadUrl:'https://android.spdmteam.com/',downloadVngUrl:'https://vng.spdmteam.com/'},
  ...
  // Codex
  {id:3,name:'Codex',rating:4.8,avatar:'https://files.catbox.moe/t43q3r.webp',version:'2.715.1115',versionVng:'2.715.1115',status:'offline',statusVng:'online',platforms:['android'],downloadUrl:'https://www.mediafire.com/file/qpitgkaqtwfj9st/Codex+v2.715.apk/file',downloadVngUrl:'https://www.mediafire.com/file/5p08n8qhtsv4x3s/Codex+VNG+V2.715+No+Key.apk/file'},
  ...
  // Trigon
  {id:9,name:'Trigon',rating:4.5,avatar:'https://img.upanh.moe/ynRPDwBx/81e69e89eab4.webp',version:'2.715.1115',versionVng:'2.708.880',status:'offline',statusVng:'offline',platforms:['android'],downloadUrl:'https://trigonevo.com/download?os=android&fs=Mediafire',downloadVngUrl:'https://www.mediafire.com/file/cyd1thmejxujgdp/Trigon+VNG+V2.708.apk/file'},

  // Vega X
  {id:10,name:'Vega X',rating:4.4,avatar:'https://vegax.gg/assets/img/V_logo_white.png',version:'2.715.1115',versionVng:null,status:'offline',statusVng:null,platforms:['android'],downloadUrl:'https://github.com/1f0yt/community/releases',downloadVngUrl:null},
  ...
  {id:14,name:'Velocity',rating:4.4,avatar:'https://files.catbox.moe/tj6brv.png',version:'9d412f44a6fe4081',versionVng:null,status:'online',statusVng:null,platforms:['windows'],downloadUrl:'https://gofile.io/d/5qcz7x',downloadVngUrl:null},
  ...
  {id:18,name:'Madium',rating:4.6,avatar:'https://files.catbox.moe/c6crdn.webp',version:'9d412f44a6fe4081',versionVng:null,status:'online',statusVng:null,platforms:['windows'],downloadUrl:'https://gofile.io/d/QARcWD',downloadVngUrl:null},
];
